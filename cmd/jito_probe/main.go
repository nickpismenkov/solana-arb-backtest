// Command jito_probe is a connectivity check for the Jito block engine
// (safe — read-only, no bundle sent, no money). Confirms we can reach the
// region-matched block engine and fetch tip accounts before wiring live
// submission.
//
