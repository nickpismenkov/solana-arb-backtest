...
const (
	...
	Geyser_SubscribeDeshred_FullMethodName    = "/geyser.Geyser/SubscribeDeshred"
...
type GeyserClient interface {
	...
	SubscribeDeshred(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SubscribeDeshredRequest, SubscribeUpdateDeshred], error)
...
func (c *geyserClient) SubscribeDeshred(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SubscribeDeshredRequest, SubscribeUpdateDeshred], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Geyser_ServiceDesc.Streams[1], Geyser_SubscribeDeshred_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeDeshredRequest, SubscribeUpdateDeshred]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Geyser_SubscribeDeshredClient = grpc.BidiStreamingClient[SubscribeDeshredRequest, SubscribeUpdateDeshred]
...
type GeyserServer interface {
	...
	SubscribeDeshred(grpc.BidiStreamingServer[SubscribeDeshredRequest, SubscribeUpdateDeshred]) error
...
func (UnimplementedGeyserServer) SubscribeDeshred(grpc.BidiStreamingServer[SubscribeDeshredRequest, SubscribeUpdateDeshred]) error {
	return status.Error(codes.Unimplemented, "method SubscribeDeshred not implemented")
}
func (UnimplementedGeyserServer) SubscribeReplayInfo(context.Context, *SubscribeReplayInfoRequest) (*SubscribeReplayInfoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SubscribeReplayInfo not implemented")
}
...
func (UnimplementedGeyserServer) GetLatestBlockhash(context.Context, *GetLatestBlockhashRequest) (*GetLatestBlockhashResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLatestBlockhash not implemented")
}
...
func (UnimplementedGeyserServer) IsBlockhashValid(context.Context, *IsBlockhashValidRequest) (*IsBlockhashValidResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IsBlockhashValid not implemented")
}
...
func RegisterGeyserServer(s grpc.ServiceRegistrar, srv GeyserServer) {
	// If the following call panics, it indicates UnimplementedGeyserServer was
...
func _Geyser_SubscribeDeshred_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GeyserServer).SubscribeDeshred(&grpc.GenericServerStream[SubscribeDeshredRequest, SubscribeUpdateDeshred]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Geyser_SubscribeDeshredServer = grpc.BidiStreamingServer[SubscribeDeshredRequest, SubscribeUpdateDeshred]
...
var Geyser_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SubscribeDeshred",
			Handler:       _Geyser_SubscribeDeshred_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
