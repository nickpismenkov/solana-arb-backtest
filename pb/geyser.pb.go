...
type CuckooHashAlgorithm int32

const (
	CuckooHashAlgorithm_SIP_HASH CuckooHashAlgorithm = 0
)

// Enum value maps for CuckooHashAlgorithm.
var (
	CuckooHashAlgorithm_name = map[int32]string{
		0: "SIP_HASH",
	}
	CuckooHashAlgorithm_value = map[string]int32{
		"SIP_HASH": 0,
	}
)

func (x CuckooHashAlgorithm) Enum() *CuckooHashAlgorithm {
	p := new(CuckooHashAlgorithm)
	*p = x
	return p
}

func (x CuckooHashAlgorithm) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CuckooHashAlgorithm) Descriptor() protoreflect.EnumDescriptor {
	return file_geyser_proto_enumTypes[2].Descriptor()
}

func (CuckooHashAlgorithm) Type() protoreflect.EnumType {
	return &file_geyser_proto_enumTypes[2]
}

func (x CuckooHashAlgorithm) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CuckooHashAlgorithm.Descriptor instead.
func (CuckooHashAlgorithm) EnumDescriptor() ([]byte, []int) {
...
func (TokenAccountExpansionControlFlag) Descriptor() protoreflect.EnumDescriptor {
	return file_geyser_proto_enumTypes[3].Descriptor()
}

func (TokenAccountExpansionControlFlag) Type() protoreflect.EnumType {
	return &file_geyser_proto_enumTypes[3]
}
...
type CuckooFilter struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Data             []byte                 `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`                                                    // bucket data
	BucketCount      uint32                 `protobuf:"varint,2,opt,name=bucket_count,json=bucketCount,proto3" json:"bucket_count,omitempty"`                  // number of buckets
	EntriesPerBucket uint32                 `protobuf:"varint,3,opt,name=entries_per_bucket,json=entriesPerBucket,proto3" json:"entries_per_bucket,omitempty"` // slots per bucket (typically 4)
	FingerprintBits  uint32                 `protobuf:"varint,4,opt,name=fingerprint_bits,json=fingerprintBits,proto3" json:"fingerprint_bits,omitempty"`      // fingerprint size (8, 12, or 16)
	HashSeed         uint64                 `protobuf:"varint,5,opt,name=hash_seed,json=hashSeed,proto3" json:"hash_seed,omitempty"`                           // seed for deterministic hashing
	HashAlgorithm    CuckooHashAlgorithm    `protobuf:"varint,6,opt,name=hash_algorithm,json=hashAlgorithm,proto3,enum=geyser.CuckooHashAlgorithm" json:"hash_algorithm,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *CuckooFilter) Reset() {
	*x = CuckooFilter{}
...
func (x *CuckooFilter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CuckooFilter) ProtoMessage() {}

func (x *CuckooFilter) ProtoReflect() protoreflect.Message {
	mi := &file_geyser_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CuckooFilter.ProtoReflect.Descriptor instead.
func (*CuckooFilter) Descriptor() ([]byte, []int) {
	return file_geyser_proto_rawDescGZIP(), []int{1}
}

func (x *CuckooFilter) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *CuckooFilter) GetBucketCount() uint32 {
	if x != nil {
...
func (x *CuckooFilter) GetEntriesPerBucket() uint32 {
	if x != nil {
		return x.EntriesPerBucket
	}
	return 0
}

func (x *CuckooFilter) GetFingerprintBits() uint32 {
	if x != nil {
		return x.FingerprintBits
	}
	return 0
}

func (x *CuckooFilter) GetHashSeed() uint64 {
	if x != nil {
		return x.HashSeed
	}
	return 0
...
func (x *CuckooFilter) GetHashAlgorithm() CuckooHashAlgorithm {
	if x != nil {
		return x.HashAlgorithm
	}
	return CuckooHashAlgorithm_SIP_HASH
}
...
type SubscribeRequestFilterAccounts struct {
	...
	CuckooAccountsFilter *CuckooFilter                           `protobuf:"bytes,6,opt,name=cuckoo_accounts_filter,json=cuckooAccountsFilter,proto3,oneof" json:"cuckoo_accounts_filter,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *SubscribeRequestFilterAccounts) GetCuckooAccountsFilter() *CuckooFilter {
	if x != nil {
		return x.CuckooAccountsFilter
	}
	return nil
}
...
type SubscribeRequestFilterBlocks struct {
	...
	CuckooAccountInclude *CuckooFilter          `protobuf:"bytes,5,opt,name=cuckoo_account_include,json=cuckooAccountInclude,proto3,oneof" json:"cuckoo_account_include,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *SubscribeRequestFilterBlocks) GetCuckooAccountInclude() *CuckooFilter {
	if x != nil {
		return x.CuckooAccountInclude
	}
	return nil
}
...
type SubscribeRequestFilterDeshredTransactions struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Vote            *bool                  `protobuf:"varint,1,opt,name=vote,proto3,oneof" json:"vote,omitempty"`
...
func (x *SubscribeRequestFilterDeshredTransactions) Reset() {
	*x = SubscribeRequestFilterDeshredTransactions{}
	mi := &file_geyser_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SubscribeRequestFilterDeshredTransactions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubscribeRequestFilterDeshredTransactions) ProtoMessage() {}

func (x *SubscribeRequestFilterDeshredTransactions) ProtoReflect() protoreflect.Message {
	mi := &file_geyser_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubscribeRequestFilterDeshredTransactions.ProtoReflect.Descriptor instead.
func (*SubscribeRequestFilterDeshredTransactions) Descriptor() ([]byte, []int) {
	return file_geyser_proto_rawDescGZIP(), []int{11}
}

func (x *SubscribeRequestFilterDeshredTransactions) GetVote() bool {
	if x != nil && x.Vote != nil {
		return *x.Vote
	}
	return false
...
func (x *SubscribeRequestFilterDeshredTransactions) GetAccountInclude() []string {
	if x != nil {
		return x.AccountInclude
	}
	return nil
...
func (x *SubscribeRequestFilterDeshredTransactions) GetAccountExclude() []string {
	if x != nil {
		return x.AccountExclude
	}
	return nil
...
func (x *SubscribeRequestFilterDeshredTransactions) GetAccountRequired() []string {
	if x != nil {
		return x.AccountRequired
	}
	return nil
...
type SubscribeDeshredRequest struct {
	state               protoimpl.MessageState                                `protogen:"open.v1"`
	DeshredTransactions map[string]*SubscribeRequestFilterDeshredTransactions `protobuf:"bytes,1,rep,name=deshred_transactions,json=deshredTransactions,proto3" json:"deshred_transactions,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	Ping                *SubscribeRequestPing                                 `protobuf:"bytes,2,opt,name=ping,proto3,oneof" json:"ping,omitempty"`
	Slots               map[string]*SubscribeRequestFilterSlots               `protobuf:"bytes,3,rep,name=slots,proto3" json:"slots,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}

func (x *SubscribeDeshredRequest) Reset() {
	*x = SubscribeDeshredRequest{}
	mi := &file_geyser_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SubscribeDeshredRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubscribeDeshredRequest) ProtoMessage() {}

func (x *SubscribeDeshredRequest) ProtoReflect() protoreflect.Message {
	mi := &file_geyser_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubscribeDeshredRequest.ProtoReflect.Descriptor instead.
func (*SubscribeDeshredRequest) Descriptor() ([]byte, []int) {
	return file_geyser_proto_rawDescGZIP(), []int{14}
}

func (x *SubscribeDeshredRequest) GetDeshredTransactions() map[string]*SubscribeRequestFilterDeshredTransactions {
	if x != nil {
		return x.DeshredTransactions
	}
	return nil
}

func (x *SubscribeDeshredRequest) GetPing() *SubscribeRequestPing {
	if x != nil {
		return x.Ping
	}
	return nil
...
func (x *SubscribeDeshredRequest) GetSlots() map[string]*SubscribeRequestFilterSlots {
	if x != nil {
		return x.Slots
	}
	return nil
...
type SubscribeUpdateDeshredTransaction struct {
	state         protoimpl.MessageState                 `protogen:"open.v1"`
	Transaction   *SubscribeUpdateDeshredTransactionInfo `protobuf:"bytes,1,opt,name=transaction,proto3" json:"transaction,omitempty"`
	Slot          uint64                                 `protobuf:"varint,2,opt,name=slot,proto3" json:"slot,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SubscribeUpdateDeshredTransaction) Reset() {
	*x = SubscribeUpdateDeshredTransaction{}
	mi := &file_geyser_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SubscribeUpdateDeshredTransaction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubscribeUpdateDeshredTransaction) ProtoMessage() {}

func (x *SubscribeUpdateDeshredTransaction) ProtoReflect() protoreflect.Message {
	mi := &file_geyser_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubscribeUpdateDeshredTransaction.ProtoReflect.Descriptor instead.
func (*SubscribeUpdateDeshredTransaction) Descriptor() ([]byte, []int) {
	return file_geyser_proto_rawDescGZIP(), []int{25}
}

func (x *SubscribeUpdateDeshredTransaction) GetTransaction() *SubscribeUpdateDeshredTransactionInfo {
	if x != nil {
		return x.Transaction
	}
	return nil
...
func (x *SubscribeUpdateDeshredTransaction) GetSlot() uint64 {
	if x != nil {
		return x.Slot
	}
	return 0
...
type SubscribeUpdateDeshredTransactionInfo struct {
	state                                     protoimpl.MessageState `protogen:"open.v1"`
	Signature                                 []byte                 `protobuf:"bytes,1,opt,name=signature,proto3" json:"signature,omitempty"`
	IsVote                                    bool                   `protobuf:"varint,2,opt,name=is_vote,json=isVote,proto3" json:"is_vote,omitempty"`
	Transaction                               *Transaction           `protobuf:"bytes,3,opt,name=transaction,proto3" json:"transaction,omitempty"`
	LoadedWritableAddresses                   [][]byte               `protobuf:"bytes,4,rep,name=loaded_writable_addresses,json=loadedWritableAddresses,proto3" json:"loaded_writable_addresses,omitempty"`
	LoadedReadonlyAddresses                   [][]byte               `protobuf:"bytes,5,rep,name=loaded_readonly_addresses,json=loadedReadonlyAddresses,proto3" json:"loaded_readonly_addresses,omitempty"`
	CompletedDataSetStartingShredIndex        uint32                 `protobuf:"varint,6,opt,name=completed_data_set_starting_shred_index,json=completedDataSetStartingShredIndex,proto3" json:"completed_data_set_starting_shred_index,omitempty"`
	CompletedDataSetEndingShredIndexExclusive uint32                 `protobuf:"varint,7,opt,name=completed_data_set_ending_shred_index_exclusive,json=completedDataSetEndingShredIndexExclusive,proto3" json:"completed_data_set_ending_shred_index_exclusive,omitempty"`
	unknownFields                             protoimpl.UnknownFields
	sizeCache                                 protoimpl.SizeCache
}

func (x *SubscribeUpdateDeshredTransactionInfo) Reset() {
	*x = SubscribeUpdateDeshredTransactionInfo{}
	mi := &file_geyser_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SubscribeUpdateDeshredTransactionInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubscribeUpdateDeshredTransactionInfo) ProtoMessage() {}

func (x *SubscribeUpdateDeshredTransactionInfo) ProtoReflect() protoreflect.Message {
	mi := &file_geyser_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubscribeUpdateDeshredTransactionInfo.ProtoReflect.Descriptor instead.
func (*SubscribeUpdateDeshredTransactionInfo) Descriptor() ([]byte, []int) {
	return file_geyser_proto_rawDescGZIP(), []int{26}
}

func (x *SubscribeUpdateDeshredTransactionInfo) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
func (x *SubscribeUpdateDeshredTransactionInfo) GetIsVote() bool {
	if x != nil {
		return x.IsVote
	}
	return false
...
func (x *SubscribeUpdateDeshredTransactionInfo) GetTransaction() *Transaction {
	if x != nil {
		return x.Transaction
	}
	return nil
...
func (x *SubscribeUpdateDeshredTransactionInfo) GetLoadedWritableAddresses() [][]byte {
	if x != nil {
...
func (x *SubscribeUpdateDeshredTransactionInfo) GetLoadedReadonlyAddresses() [][]byte {
	if x != nil {
...
func (x *SubscribeUpdateDeshredTransactionInfo) GetCompletedDataSetStartingShredIndex() uint32 {
	if x != nil {
		return x.CompletedDataSetStartingShredIndex
	}
	return 0
}

func (x *SubscribeUpdateDeshredTransactionInfo) GetCompletedDataSetEndingShredIndexExclusive() uint32 {
	if x != nil {
		return x.CompletedDataSetEndingShredIndexExclusive
	}
	return 0
}
...
type SubscribeUpdateDeshred struct {
	state   protoimpl.MessageState `protogen:"open.v1"`
	Filters []string               `protobuf:"bytes,1,rep,name=filters,proto3" json:"filters,omitempty"`
	// Types that are valid to be assigned to UpdateOneof:
	//
	//	*SubscribeUpdateDeshred_DeshredTransaction
	//	*SubscribeUpdateDeshred_Ping
	//	*SubscribeUpdateDeshred_Pong
	//	*SubscribeUpdateDeshred_Slot
	UpdateOneof   isSubscribeUpdateDeshred_UpdateOneof `protobuf_oneof:"update_oneof"`
	CreatedAt     *timestamppb.Timestamp               `protobuf:"bytes,5,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SubscribeUpdateDeshred) Reset() {
	*x = SubscribeUpdateDeshred{}
	mi := &file_geyser_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SubscribeUpdateDeshred) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubscribeUpdateDeshred) ProtoMessage() {}

func (x *SubscribeUpdateDeshred) ProtoReflect() protoreflect.Message {
	mi := &file_geyser_proto_msgTypes[29]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubscribeUpdateDeshred.ProtoReflect.Descriptor instead.
func (*SubscribeUpdateDeshred) Descriptor() ([]byte, []int) {
	return file_geyser_proto_rawDescGZIP(), []int{29}
}

func (x *SubscribeUpdateDeshred) GetFilters() []string {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *SubscribeUpdateDeshred) GetUpdateOneof() isSubscribeUpdateDeshred_UpdateOneof {
	if x != nil {
		return x.UpdateOneof
	}
	return nil
...
func (x *SubscribeUpdateDeshred) GetDeshredTransaction() *SubscribeUpdateDeshredTransaction {
	if x != nil {
		if x, ok := x.UpdateOneof.(*SubscribeUpdateDeshred_DeshredTransaction); ok {
			return x.DeshredTransaction
		}
	}
	return nil
}

func (x *SubscribeUpdateDeshred) GetPing() *SubscribeUpdatePing {
	if x != nil {
		if x, ok := x.UpdateOneof.(*SubscribeUpdateDeshred_Ping); ok {
			return x.Ping
		}
	}
	return nil
...
func (x *SubscribeUpdateDeshred) GetPong() *SubscribeUpdatePong {
	if x != nil {
		if x, ok := x.UpdateOneof.(*SubscribeUpdateDeshred_Pong); ok {
			return x.Pong
		}
	}
	return nil
...
func (x *SubscribeUpdateDeshred) GetSlot() *SubscribeUpdateSlot {
	if x != nil {
		if x, ok := x.UpdateOneof.(*SubscribeUpdateDeshred_Slot); ok {
			return x.Slot
		}
	}
	return nil
...
func (x *SubscribeUpdateDeshred) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
type isSubscribeUpdateDeshred_UpdateOneof interface {
	isSubscribeUpdateDeshred_UpdateOneof()
}

type SubscribeUpdateDeshred_DeshredTransaction struct {
	DeshredTransaction *SubscribeUpdateDeshredTransaction `protobuf:"bytes,2,opt,name=deshred_transaction,json=deshredTransaction,proto3,oneof"`
}

type SubscribeUpdateDeshred_Ping struct {
	Ping *SubscribeUpdatePing `protobuf:"bytes,3,opt,name=ping,proto3,oneof"`
}

type SubscribeUpdateDeshred_Pong struct {
	Pong *SubscribeUpdatePong `protobuf:"bytes,4,opt,name=pong,proto3,oneof"`
}

type SubscribeUpdateDeshred_Slot struct {
	// field 5 is reserved for created_at (below the oneof)
	Slot *SubscribeUpdateSlot `protobuf:"bytes,6,opt,name=slot,proto3,oneof"`
}

func (*SubscribeUpdateDeshred_DeshredTransaction) isSubscribeUpdateDeshred_UpdateOneof() {}

func (*SubscribeUpdateDeshred_Ping) isSubscribeUpdateDeshred_UpdateOneof() {}

func (*SubscribeUpdateDeshred_Pong) isSubscribeUpdateDeshred_UpdateOneof() {}

func (*SubscribeUpdateDeshred_Slot) isSubscribeUpdateDeshred_UpdateOneof() {}
...
const file_geyser_proto_rawDesc = "" +
	...
	"\n" +
	"_from_slot\"\xff\x01\n" +
	"\fCuckooFilter\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\x12!\n" +
	"\fbucket_count\x18\x02 \x01(\rR\vbucketCount\x12,\n" +
	"\x12entries_per_bucket\x18\x03 \x01(\rR\x10entriesPerBucket\x12)\n" +
	"\x10fingerprint_bits\x18\x04 \x01(\rR\x0ffingerprintBits\x12\x1b\n" +
	"\thash_seed\x18\x05 \x01(\x04R\bhashSeed\x12B\n" +
	"\x0ehash_algorithm\x18\x06 \x01(\x0e2\x1b.geyser.CuckooHashAlgorithmR\rhashAlgorithm\"\xda\x02\n" +
	...
	"\x16nonempty_txn_signature\x18\x05 \x01(\bH\x00R\x14nonemptyTxnSignature\x88\x01\x01\x12O\n" +
	"\x16cuckoo_accounts_filter\x18\x06 \x01(\v2\x14.geyser.CuckooFilterH\x01R\x14cuckooAccountsFilter\x88\x01\x01B\x19\n" +
	"\x17_nonempty_txn_signatureB\x19\n" +
	"\x17_cuckoo_accounts_filter\"\xa2\x02\n" +
	...
	"\x0finclude_entries\x18\x04 \x01(\bH\x02R\x0eincludeEntries\x88\x01\x01\x12O\n" +
	"\x16cuckoo_account_include\x18\x05 \x01(\v2\x14.geyser.CuckooFilterH\x03R\x14cuckooAccountInclude\x88\x01\x01B\x17\n" +
	...
	"\x1bSubscribeRequestFilterEntry\"\xca\x01\n" +
	")SubscribeRequestFilterDeshredTransactions\x12\x17\n" +
	"\x04vote\x18\x01 \x01(\bH\x00R\x04vote\x88\x01\x01\x12'\n" +
	"\x0faccount_include\x18\x02 \x03(\tR\x0eaccountInclude\x12'\n" +
	"\x0faccount_exclude\x18\x03 \x03(\tR\x0eaccountExclude\x12)\n" +
	"\x10account_required\x18\x04 \x03(\tR\x0faccountRequiredB\a\n" +
	"\x05_vote\"S\n" +
	"!SubscribeRequestAccountsDataSlice\x12\x16\n" +
	"\x06offset\x18\x01 \x01(\x04R\x06offset\x12\x16\n" +
	"\x06length\x18\x02 \x01(\x04R\x06length\"&\n" +
	"\x14SubscribeRequestPing\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\"\xe2\x03\n" +
	"\x17SubscribeDeshredRequest\x12k\n" +
	"\x14deshred_transactions\x18\x01 \x03(\v28.geyser.SubscribeDeshredRequest.DeshredTransactionsEntryR\x13deshredTransactions\x125\n" +
	"\x04ping\x18\x02 \x01(\v2\x1c.geyser.SubscribeRequestPingH\x00R\x04ping\x88\x01\x01\x12@\n" +
	"\x05slots\x18\x03 \x03(\v2*.geyser.SubscribeDeshredRequest.SlotsEntryR\x05slots\x1ay\n" +
	"\x18DeshredTransactionsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12G\n" +
	"\x05value\x18\x02 \x01(\v21.geyser.SubscribeRequestFilterDeshredTransactionsR\x05value:\x028\x01\x1a]\n" +
	"\n" +
	"SlotsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x129\n" +
	"\x05value\x18\x02 \x01(\v2#.geyser.SubscribeRequestFilterSlotsR\x05value:\x028\x01B\a\n" +
	"\x05_ping\"\x9d\x05\n" +
	...
	"\x04slot\x18\x02 \x01(\x04R\x04slot\"\xdd\x03\n" +
	"%SubscribeUpdateDeshredTransactionInfo\x12\x1c\n" +
	"\tsignature\x18\x01 \x01(\fR\tsignature\x12\x17\n" +
	"\ais_vote\x18\x02 \x01(\bR\x06isVote\x12L\n" +
	"\vtransaction\x18\x03 \x01(\v2*.solana.storage.ConfirmedBlock.TransactionR\vtransaction\x12:\n" +
	"\x19loaded_writable_addresses\x18\x04 \x03(\fR\x17loadedWritableAddresses\x12:\n" +
	"\x19loaded_readonly_addresses\x18\x05 \x03(\fR\x17loadedReadonlyAddresses\x12S\n" +
	"'completed_data_set_starting_shred_index\x18\x06 \x01(\rR\"completedDataSetStartingShredIndex\x12b\n" +
	"/completed_data_set_ending_shred_index_exclusive\x18\a \x01(\rR)completedDataSetEndingShredIndexExclusive\"\x15\n" +
	"\x13SubscribeUpdatePing\"%\n" +
	"\x13SubscribeUpdatePong\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\"\xf4\x02\n" +
	"\x16SubscribeUpdateDeshred\x12\x18\n" +
	"\afilters\x18\x01 \x03(\tR\afilters\x12\\\n" +
	"\x13deshred_transaction\x18\x02 \x01(\v2).geyser.SubscribeUpdateDeshredTransactionH\x00R\x12deshredTransaction\x121\n" +
	"\x04ping\x18\x03 \x01(\v2\x1b.geyser.SubscribeUpdatePingH\x00R\x04ping\x121\n" +
	"\x04pong\x18\x04 \x01(\v2\x1b.geyser.SubscribeUpdatePongH\x00R\x04pong\x121\n" +
	"\x04slot\x18\x06 \x01(\v2\x1b.geyser.SubscribeUpdateSlotH\x00R\x04slot\x129\n" +
	"\n" +
	...
	"\tSLOT_DEAD\x10\x06*#\n" +
	"\x13CuckooHashAlgorithm\x12\f\n" +
	"\bSIP_HASH\x10\x00*@\n" +
	" TokenAccountExpansionControlFlag\x12\a\n" +
	"\x03ALL\x10\x00\x12\x13\n" +
	"\x0fBALANCE_CHANGED\x10\x012\xd0\x05\n" +
	"\x06Geyser\x12D\n" +
	"\tSubscribe\x12\x18.geyser.SubscribeRequest\x1a\x17.geyser.SubscribeUpdate\"\x00(\x010\x01\x12Y\n" +
	"\x10SubscribeDeshred\x12\x1f.geyser.SubscribeDeshredRequest\x1a\x1e.geyser.SubscribeUpdateDeshred\"\x00(\x010\x01\x12`\n" +
	...
	"\n" +
	"GetVersion\x12\x19.geyser.GetVersionRequest\x1a\x1a.geyser.GetVersionResponse\"\x00BFZDgithub.com/nickpismenkov/solana-arb-backtest/internal/yellowstone/pbP\x01b\x06proto3"
...
var file_geyser_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_geyser_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_geyser_proto_goTypes = []any{
	(CommitmentLevel)(0),                                 // 0: geyser.CommitmentLevel
	(SlotStatus)(0),                                      // 1: geyser.SlotStatus
	(CuckooHashAlgorithm)(0),                             // 2: geyser.CuckooHashAlgorithm
	(TokenAccountExpansionControlFlag)(0),                // 3: geyser.TokenAccountExpansionControlFlag
	(*SubscribeRequest)(nil),                             // 4: geyser.SubscribeRequest
	(*CuckooFilter)(nil),                                 // 5: geyser.CuckooFilter
	(*SubscribeRequestFilterAccounts)(nil),               // 6: geyser.SubscribeRequestFilterAccounts
	(*SubscribeRequestFilterAccountsFilter)(nil),         // 7: geyser.SubscribeRequestFilterAccountsFilter
	(*SubscribeRequestFilterAccountsFilterMemcmp)(nil),   // 8: geyser.SubscribeRequestFilterAccountsFilterMemcmp
	(*SubscribeRequestFilterAccountsFilterLamports)(nil), // 9: geyser.SubscribeRequestFilterAccountsFilterLamports
	(*SubscribeRequestFilterSlots)(nil),                  // 10: geyser.SubscribeRequestFilterSlots
	(*SubscribeRequestFilterTransactions)(nil),           // 11: geyser.SubscribeRequestFilterTransactions
	(*SubscribeRequestFilterBlocks)(nil),                 // 12: geyser.SubscribeRequestFilterBlocks
	(*SubscribeRequestFilterBlocksMeta)(nil),             // 13: geyser.SubscribeRequestFilterBlocksMeta
	(*SubscribeRequestFilterEntry)(nil),                  // 14: geyser.SubscribeRequestFilterEntry
	(*SubscribeRequestFilterDeshredTransactions)(nil),    // 15: geyser.SubscribeRequestFilterDeshredTransactions
	(*SubscribeRequestAccountsDataSlice)(nil),            // 16: geyser.SubscribeRequestAccountsDataSlice
	(*SubscribeRequestPing)(nil),                         // 17: geyser.SubscribeRequestPing
	(*SubscribeDeshredRequest)(nil),                      // 18: geyser.SubscribeDeshredRequest
	(*SubscribeUpdate)(nil),                              // 19: geyser.SubscribeUpdate
	(*SubscribeUpdateAccount)(nil),                       // 20: geyser.SubscribeUpdateAccount
	(*SubscribeUpdateAccountInfo)(nil),                   // 21: geyser.SubscribeUpdateAccountInfo
	(*SubscribeUpdateSlot)(nil),                          // 22: geyser.SubscribeUpdateSlot
	(*SubscribeUpdateTransaction)(nil),                   // 23: geyser.SubscribeUpdateTransaction
	(*SubscribeUpdateTransactionInfo)(nil),               // 24: geyser.SubscribeUpdateTransactionInfo
	(*SubscribeUpdateTransactionStatus)(nil),             // 25: geyser.SubscribeUpdateTransactionStatus
	(*SubscribeUpdateBlock)(nil),                         // 26: geyser.SubscribeUpdateBlock
	(*SubscribeUpdateBlockMeta)(nil),                     // 27: geyser.SubscribeUpdateBlockMeta
	(*SubscribeUpdateEntry)(nil),                         // 28: geyser.SubscribeUpdateEntry
	(*SubscribeUpdateDeshredTransaction)(nil),            // 29: geyser.SubscribeUpdateDeshredTransaction
	(*SubscribeUpdateDeshredTransactionInfo)(nil),        // 30: geyser.SubscribeUpdateDeshredTransactionInfo
	(*SubscribeUpdatePing)(nil),                          // 31: geyser.SubscribeUpdatePing
	(*SubscribeUpdatePong)(nil),                          // 32: geyser.SubscribeUpdatePong
	(*SubscribeUpdateDeshred)(nil),                       // 33: geyser.SubscribeUpdateDeshred
	(*SubscribeReplayInfoRequest)(nil),                   // 34: geyser.SubscribeReplayInfoRequest
	(*SubscribeReplayInfoResponse)(nil),                  // 35: geyser.SubscribeReplayInfoResponse
	(*PingRequest)(nil),                                  // 36: geyser.PingRequest
	(*PongResponse)(nil),                                 // 37: geyser.PongResponse
	(*GetLatestBlockhashRequest)(nil),                    // 38: geyser.GetLatestBlockhashRequest
	(*GetLatestBlockhashResponse)(nil),                   // 39: geyser.GetLatestBlockhashResponse
	(*GetBlockHeightRequest)(nil),                        // 40: geyser.GetBlockHeightRequest
	(*GetBlockHeightResponse)(nil),                       // 41: geyser.GetBlockHeightResponse
	(*GetSlotRequest)(nil),                               // 42: geyser.GetSlotRequest
	(*GetSlotResponse)(nil),                              // 43: geyser.GetSlotResponse
	(*GetVersionRequest)(nil),                            // 44: geyser.GetVersionRequest
	(*GetVersionResponse)(nil),                           // 45: geyser.GetVersionResponse
	(*IsBlockhashValidRequest)(nil),                      // 46: geyser.IsBlockhashValidRequest
	(*IsBlockhashValidResponse)(nil),                     // 47: geyser.IsBlockhashValidResponse
	...
	nil,                                                  // 55: geyser.SubscribeDeshredRequest.DeshredTransactionsEntry
	nil,                                                  // 56: geyser.SubscribeDeshredRequest.SlotsEntry
	(*timestamppb.Timestamp)(nil),                        // 57: google.protobuf.Timestamp
	(*Transaction)(nil),                                  // 58: solana.storage.ConfirmedBlock.Transaction
	(*TransactionStatusMeta)(nil),                        // 59: solana.storage.ConfirmedBlock.TransactionStatusMeta
	(*TransactionError)(nil),                             // 60: solana.storage.ConfirmedBlock.TransactionError
	(*Rewards)(nil),                                      // 61: solana.storage.ConfirmedBlock.Rewards
	(*UnixTimestamp)(nil),                                // 62: solana.storage.ConfirmedBlock.UnixTimestamp
	(*BlockHeight)(nil),                                  // 63: solana.storage.ConfirmedBlock.BlockHeight
}
var file_geyser_proto_depIdxs = []int32{
	48, // 0: geyser.SubscribeRequest.accounts:type_name -> geyser.SubscribeRequest.AccountsEntry
	49, // 1: geyser.SubscribeRequest.slots:type_name -> geyser.SubscribeRequest.SlotsEntry
	50, // 2: geyser.SubscribeRequest.transactions:type_name -> geyser.SubscribeRequest.TransactionsEntry
	51, // 3: geyser.SubscribeRequest.transactions_status:type_name -> geyser.SubscribeRequest.TransactionsStatusEntry
	52, // 4: geyser.SubscribeRequest.blocks:type_name -> geyser.SubscribeRequest.BlocksEntry
	53, // 5: geyser.SubscribeRequest.blocks_meta:type_name -> geyser.SubscribeRequest.BlocksMetaEntry
	54, // 6: geyser.SubscribeRequest.entry:type_name -> geyser.SubscribeRequest.EntryEntry
	0,  // 7: geyser.SubscribeRequest.commitment:type_name -> geyser.CommitmentLevel
	16, // 8: geyser.SubscribeRequest.accounts_data_slice:type_name -> geyser.SubscribeRequestAccountsDataSlice
	17, // 9: geyser.SubscribeRequest.ping:type_name -> geyser.SubscribeRequestPing
	2,  // 10: geyser.CuckooFilter.hash_algorithm:type_name -> geyser.CuckooHashAlgorithm
	7,  // 11: geyser.SubscribeRequestFilterAccounts.filters:type_name -> geyser.SubscribeRequestFilterAccountsFilter
	5,  // 12: geyser.SubscribeRequestFilterAccounts.cuckoo_accounts_filter:type_name -> geyser.CuckooFilter
	8,  // 13: geyser.SubscribeRequestFilterAccountsFilter.memcmp:type_name -> geyser.SubscribeRequestFilterAccountsFilterMemcmp
	9,  // 14: geyser.SubscribeRequestFilterAccountsFilter.lamports:type_name -> geyser.SubscribeRequestFilterAccountsFilterLamports
	3,  // 15: geyser.SubscribeRequestFilterTransactions.token_accounts:type_name -> geyser.TokenAccountExpansionControlFlag
	5,  // 16: geyser.SubscribeRequestFilterBlocks.cuckoo_account_include:type_name -> geyser.CuckooFilter
	55, // 17: geyser.SubscribeDeshredRequest.deshred_transactions:type_name -> geyser.SubscribeDeshredRequest.DeshredTransactionsEntry
	17, // 18: geyser.SubscribeDeshredRequest.ping:type_name -> geyser.SubscribeRequestPing
	56, // 19: geyser.SubscribeDeshredRequest.slots:type_name -> geyser.SubscribeDeshredRequest.SlotsEntry
	20, // 20: geyser.SubscribeUpdate.account:type_name -> geyser.SubscribeUpdateAccount
	22, // 21: geyser.SubscribeUpdate.slot:type_name -> geyser.SubscribeUpdateSlot
	23, // 22: geyser.SubscribeUpdate.transaction:type_name -> geyser.SubscribeUpdateTransaction
	25, // 23: geyser.SubscribeUpdate.transaction_status:type_name -> geyser.SubscribeUpdateTransactionStatus
	26, // 24: geyser.SubscribeUpdate.block:type_name -> geyser.SubscribeUpdateBlock
	31, // 25: geyser.SubscribeUpdate.ping:type_name -> geyser.SubscribeUpdatePing
	32, // 26: geyser.SubscribeUpdate.pong:type_name -> geyser.SubscribeUpdatePong
	27, // 27: geyser.SubscribeUpdate.block_meta:type_name -> geyser.SubscribeUpdateBlockMeta
	28, // 28: geyser.SubscribeUpdate.entry:type_name -> geyser.SubscribeUpdateEntry
	57, // 29: geyser.SubscribeUpdate.created_at:type_name -> google.protobuf.Timestamp
	21, // 30: geyser.SubscribeUpdateAccount.account:type_name -> geyser.SubscribeUpdateAccountInfo
	1,  // 31: geyser.SubscribeUpdateSlot.status:type_name -> geyser.SlotStatus
	24, // 32: geyser.SubscribeUpdateTransaction.transaction:type_name -> geyser.SubscribeUpdateTransactionInfo
	58, // 33: geyser.SubscribeUpdateTransactionInfo.transaction:type_name -> solana.storage.ConfirmedBlock.Transaction
	59, // 34: geyser.SubscribeUpdateTransactionInfo.meta:type_name -> solana.storage.ConfirmedBlock.TransactionStatusMeta
	60, // 35: geyser.SubscribeUpdateTransactionStatus.err:type_name -> solana.storage.ConfirmedBlock.TransactionError
	61, // 36: geyser.SubscribeUpdateBlock.rewards:type_name -> solana.storage.ConfirmedBlock.Rewards
	62, // 37: geyser.SubscribeUpdateBlock.block_time:type_name -> solana.storage.ConfirmedBlock.UnixTimestamp
	63, // 38: geyser.SubscribeUpdateBlock.block_height:type_name -> solana.storage.ConfirmedBlock.BlockHeight
	24, // 39: geyser.SubscribeUpdateBlock.transactions:type_name -> geyser.SubscribeUpdateTransactionInfo
	21, // 40: geyser.SubscribeUpdateBlock.accounts:type_name -> geyser.SubscribeUpdateAccountInfo
	28, // 41: geyser.SubscribeUpdateBlock.entries:type_name -> geyser.SubscribeUpdateEntry
	61, // 42: geyser.SubscribeUpdateBlockMeta.rewards:type_name -> solana.storage.ConfirmedBlock.Rewards
	62, // 43: geyser.SubscribeUpdateBlockMeta.block_time:type_name -> solana.storage.ConfirmedBlock.UnixTimestamp
	63, // 44: geyser.SubscribeUpdateBlockMeta.block_height:type_name -> solana.storage.ConfirmedBlock.BlockHeight
	30, // 45: geyser.SubscribeUpdateDeshredTransaction.transaction:type_name -> geyser.SubscribeUpdateDeshredTransactionInfo
	58, // 46: geyser.SubscribeUpdateDeshredTransactionInfo.transaction:type_name -> solana.storage.ConfirmedBlock.Transaction
	29, // 47: geyser.SubscribeUpdateDeshred.deshred_transaction:type_name -> geyser.SubscribeUpdateDeshredTransaction
	31, // 48: geyser.SubscribeUpdateDeshred.ping:type_name -> geyser.SubscribeUpdatePing
	32, // 49: geyser.SubscribeUpdateDeshred.pong:type_name -> geyser.SubscribeUpdatePong
	22, // 50: geyser.SubscribeUpdateDeshred.slot:type_name -> geyser.SubscribeUpdateSlot
	57, // 51: geyser.SubscribeUpdateDeshred.created_at:type_name -> google.protobuf.Timestamp
	0,  // 52: geyser.GetLatestBlockhashRequest.commitment:type_name -> geyser.CommitmentLevel
	0,  // 53: geyser.GetBlockHeightRequest.commitment:type_name -> geyser.CommitmentLevel
	0,  // 54: geyser.GetSlotRequest.commitment:type_name -> geyser.CommitmentLevel
	0,  // 55: geyser.IsBlockhashValidRequest.commitment:type_name -> geyser.CommitmentLevel
	6,  // 56: geyser.SubscribeRequest.AccountsEntry.value:type_name -> geyser.SubscribeRequestFilterAccounts
	10, // 57: geyser.SubscribeRequest.SlotsEntry.value:type_name -> geyser.SubscribeRequestFilterSlots
	11, // 58: geyser.SubscribeRequest.TransactionsEntry.value:type_name -> geyser.SubscribeRequestFilterTransactions
	11, // 59: geyser.SubscribeRequest.TransactionsStatusEntry.value:type_name -> geyser.SubscribeRequestFilterTransactions
	12, // 60: geyser.SubscribeRequest.BlocksEntry.value:type_name -> geyser.SubscribeRequestFilterBlocks
	13, // 61: geyser.SubscribeRequest.BlocksMetaEntry.value:type_name -> geyser.SubscribeRequestFilterBlocksMeta
	14, // 62: geyser.SubscribeRequest.EntryEntry.value:type_name -> geyser.SubscribeRequestFilterEntry
	15, // 63: geyser.SubscribeDeshredRequest.DeshredTransactionsEntry.value:type_name -> geyser.SubscribeRequestFilterDeshredTransactions
	10, // 64: geyser.SubscribeDeshredRequest.SlotsEntry.value:type_name -> geyser.SubscribeRequestFilterSlots
	4,  // 65: geyser.Geyser.Subscribe:input_type -> geyser.SubscribeRequest
	18, // 66: geyser.Geyser.SubscribeDeshred:input_type -> geyser.SubscribeDeshredRequest
	34, // 67: geyser.Geyser.SubscribeReplayInfo:input_type -> geyser.SubscribeReplayInfoRequest
	36, // 68: geyser.Geyser.Ping:input_type -> geyser.PingRequest
	38, // 69: geyser.Geyser.GetLatestBlockhash:input_type -> geyser.GetLatestBlockhashRequest
	40, // 70: geyser.Geyser.GetBlockHeight:input_type -> geyser.GetBlockHeightRequest
	42, // 71: geyser.Geyser.GetSlot:input_type -> geyser.GetSlotRequest
	46, // 72: geyser.Geyser.IsBlockhashValid:input_type -> geyser.IsBlockhashValidRequest
	44, // 73: geyser.Geyser.GetVersion:input_type -> geyser.GetVersionRequest
	19, // 74: geyser.Geyser.Subscribe:output_type -> geyser.SubscribeUpdate
	33, // 75: geyser.Geyser.SubscribeDeshred:output_type -> geyser.SubscribeUpdateDeshred
	35, // 76: geyser.Geyser.SubscribeReplayInfo:output_type -> geyser.SubscribeReplayInfoResponse
	37, // 77: geyser.Geyser.Ping:output_type -> geyser.PongResponse
	39, // 78: geyser.Geyser.GetLatestBlockhash:output_type -> geyser.GetLatestBlockhashResponse
	41, // 79: geyser.Geyser.GetBlockHeight:output_type -> geyser.GetBlockHeightResponse
	43, // 80: geyser.Geyser.GetSlot:output_type -> geyser.GetSlotResponse
	47, // 81: geyser.Geyser.IsBlockhashValid:output_type -> geyser.IsBlockhashValidResponse
	45, // 82: geyser.Geyser.GetVersion:output_type -> geyser.GetVersionResponse
...
func file_geyser_proto_init() {
	...
	file_geyser_proto_msgTypes[8].OneofWrappers = []any{}
	...
	file_geyser_proto_msgTypes[29].OneofWrappers = []any{
		(*SubscribeUpdateDeshred_DeshredTransaction)(nil),
		(*SubscribeUpdateDeshred_Ping)(nil),
		(*SubscribeUpdateDeshred_Pong)(nil),
		(*SubscribeUpdateDeshred_Slot)(nil),
	}
